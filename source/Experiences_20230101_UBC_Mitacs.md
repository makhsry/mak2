...
Collaborated with a local **mining company**, under [Mitacs Accelerate Internship](https://www.mitacs.ca/our-programs/accelerate/), to electrify kiln **drying processes** by integrating microwave-based heating systems aimed at **reducing fossil fuel dependence** (12.25 million cubic meters of natural gas), **lowering economic expenses** (e.g., $2.08 million carbon tax), and **minimizing greenhouse gas emissions** (e.g., 26,000 tons of CO2e annually).
...
- Created Bash and Python scripts for post-processing of simulation results, **data visualization**, and **executive analytics**.
...
- An **`.html`** version of the calculator can be found [**here**](tools/_COSMOSAC_Calculator.html). 

**Usage Instructions**

- The Excel file (**[`inputQM.xlsx`](tools/_COSMOSAC_inputQM.xlsx)**) must have sheets named after your **`components`** (e.g., '67-63-0-2d' or 'Z1') containing the required QM output data.
